...
void test_create_vector()
{
    ...
    {    
        Vector* vector_test_0 = create_vector_default();
        Vector* vector_test_1 = create_vector(2.0f, 64.0f, 32.0f);
        Vector* vector_test_2 = create_vector_random(min_max[0], min_max[1]);
        Vector* vector_test_3 = create_vector_random_default();
        ...
        free_vector(vector_test_2);
        free_vector(vector_test_3);
...
void test_sum_vector(void)
{
    ...
    {    
        Vector* vector_test_0 = create_vector(x_0, y_0, z_0);
        Vector* vector_test_1 = create_vector(x_1, y_1, z_1);

        Vector* result = add(vector_test_0, vector_test_1);
...
void test_sub_vector(void)
{
...

    {
        ...
        Vector* result = sub(vector_test_0, vector_test_1);
...
void test_mul_vector(void)
{
...

    {
        ...
        Vector* result = mul(vector_test_0, k);
...
void test_cross_vector(void)
{
    ...
    {        
        ...
        Vector* result = cross(vector_test_0, vector_test_1);
...
void test_normalize_vector(void)
{
...

    {
        ...
        Vector* result = norm(vector_test_0);
