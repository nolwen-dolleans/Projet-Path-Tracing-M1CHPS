...
\begin{itemize}
\item[$\_$] Génération de 2 nombres aléatoires $\xi_1$ et $\xi_2$
...
\end{itemize} 
Ainsi, on construit la direction du rayon incident $\omega_i$ de da manière suivante dans la base $\left( right, up, forward\right)$: $\omega_i = \left( x\cdot tangente, y\cdot bitangente, z\cdot normal \right)$.\\
