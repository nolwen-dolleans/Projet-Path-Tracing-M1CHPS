...
s(\vec{p}(t)) &= (p_x(t) - c_x)^2 + (p_y(t) - c_y)^2 + (p_z(t) - c_z)^2 - r^2 \\ 
              ...
              &= (\vec{d}\cdot\vec{d})t^2 + 2\vec{d}\cdot(\overrightarrow{o-c})t + (\overrightarrow{o-c})^2 - r^2
\end{align*}

Soit $s(\vec{p}(t))$ une équation quadratique, avec $a = \vec{d}\cdot\vec{d}$, $b = 2\vec{d}\cdot(\overrightarrow{o-c})$, $c = (\vec{o}-\vec{c})^2 - r^2$
...
- Une intersection si $\bigtriangleup = 0 \Rightarrow x_1 = \frac{-b}{2a}$ ;

- Deux intersections si $\bigtriangleup > 0 \Rightarrow x_1 = \frac{-b - \sqrt{\bigtriangleup} }{2a}$, $x_2 = \frac{-b + \sqrt{\bigtriangleup} }{2a}$.
