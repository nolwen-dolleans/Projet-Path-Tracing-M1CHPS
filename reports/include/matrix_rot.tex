\subsection{Résultat du Path Tracing}
\label{subsec:img_pt}

Suite au développement de notre Path Tracer, nous avons été capable d'observer en exemple la scène suivante :

\begin{figure}[H]
\centering
  \centering
  \includegraphics{include/Path_Tracing_v1.png}

  \captionof{figure}{Image 32 bits résultante du path tracer}
  \label{fig:result}
