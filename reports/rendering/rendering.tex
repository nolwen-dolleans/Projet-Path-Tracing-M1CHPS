...
\begin{document}
    ...
    $$\boxed{L_{o}\left(x, \omega_o\right) = L_{e}\left(x, \omega_o\right) + \int_{\Omega}f\left(x, \omega_o, \omega_i,\right)\cdot L_{i}\left(x, \omega_i\right)\cdot \left(\textbf{n}\bullet\omega_{i}\right)\cdot d_{\omega_o}}$$
